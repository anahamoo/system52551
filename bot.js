...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' P.help',`${client.guilds.size} servers`,` ${client.users.size} User`,'By Q20_',' P.inv',' P.sup '];
    var i = -1;
    var j = 0;
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``My ID``' , `[ ${client.user.id} ]` , true)
                  ...
                  .addField('``Owner``' , `@!- Mál , »! .Q20_#2620 ` , true)
    })
}
});
...
『P.gRole Role name ====> يوريك معلومات رتبة باسمها او الايدي حقها
『P.bot ====> يعرض لك كل معلومات البوت
...
『P.v2min ====> لصنع روم صوتي مؤقت
『P.inv ====> لدعوة البوت الى سيرفرك
**
`)
...
『P.cto ====> تغير الكلام في اعلى الروم
『P.leave ====> لطرد البوت من سيرفرك
『P.setMedia ====> لتحديد روم الصور
『P.ranks ====> يوريك رتب السيرفر
『P.vonline ====> لعمل روم صوتي اونلاين
『P.schannel ====> اضهار الشات المخفية
『P.sr Exemple ====> لتغيير اسم السيرفر
『P.kv ====> لطرد عضو من روم صوتي
『P.hchannel ====> اخفاء الشات
『P.talk ====> للتكلم بصفة البوت
『P.count ====> عدد اعضاء السيرفر
『P.setlog ====> لصنع روم اللوج
『P.server ====> يعرض لك معلومات عن السيرفر
『P.movall ====> لسحب الجميع الى رومك
『P.sug ====> suggestions لصنع اقتراح لازم روم 
『P.bs ====> لمعرفة سيرفرات البوت
『P.rooms ====> لرؤية رومات السيرفر
『P.dc ====> مسح كل الرومات
『P.dr ====>  فوق كل الرانكات
『P.allbots ====> يوريك كل البوتات في سيرفرك
『P.move ====> لسحب عضو الى روم صوتية
『P.giveaway ====> لصنع جيفواي
『P.role @mention rolename ====> لأعطاء رتبة لعضو معين
『P.role all rolename ====> لأعطاء رتبة للجميع
『P.role humans rolename ====> لأعطاء رتبة للاشخاص فقط
『P.role bots rolename ====> لأعطاء رتبة لجميع البوتات
『P.members ====> حالات اعضاء السيرفر
...
『P.ban @user <reason> ====> حضر الشخص من السيرفر
『P.unban @user ====> لفك حضر الشخص من السيرفر
『P.mutechannel ====> تقفيل الشات
『P.unmutechannel ====> فتح الشات
『P.ct <name> ====> انشاء شات
『P.cv <name> ====> انشاء رووم فويس
**
`)
   message.author.sendEmbed(embed)
      message.reply('تم ارسالك بلخاص')
 ...
 **       
『P.8ball ====> لعبه تسال البوت اسال  وهو يجاوب عنها
『P.cuttweet ====> لعبة كت تويت
『P.هل تعل
『P.cal ====> ألة حاسبة
『P.za5 ====> لزخرفة ما تقول
『P.cats ====> قطط كيوت
『P.love ====> يعطيك اقوال عن الحب 
『P.حكم
『P.جمع
『P.طرح
『P.ضرب
...
reaction3.on("collect", r => {
  const embed = new Discord.RichEmbed()
      .setColor("#000000")
      .setDescription(`**
            -=-  الرومات اللازمة للبوت وكمان اشي لازم تفعله -=-
『=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.』
...
روم التوديع leave
=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.
P.toggle-antibot-on لي منع دخلو البوتات
=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.
P.toggle-antibot-off لو عوز دخل بوت لي سيرفرك = كل دا علشان حماية لي سيرفرك
=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.
P.autorole منشن الرتبة 
=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.
P.Antihack لي منع التهكير
『=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.』
**`)
   message.author.sendEmbed(embed)
})
...
client.on('message', message => {
if(message.content.startsWith("P.فواكه")) {
  let slot1 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
 ...
 **:heart: 
رابط السيرفر | https://discord.gg/VpQSNSr :gem:
 **:heart: 
`);
  message.author.sendEmbed(embed);
   }
...
client.on('message', message => {
    if (message.author.id !== '505022273418428426') return;
...
→ | عدد السيرفرات الحاليه : \`${client.guilds.size}\`**`)
        .setColor('RANDOM')
client.guilds.get('542320014061993985').channels.get('558711973597020160').send(embed)
}); 
...
→ | عدد السيرفرات الحاليه : \`${client.guilds.size}\`**`)
        .setColor('RANDOM')
client.guilds.get('542320014061993985').channels.get('558712000201359370').send(embed)
});

  
const antb = JSON.parse(fs.readFileSync('./antibot.json' , 'utf8'));//سوي ملف antibot.json
client.on('message', message => {
    if(message.content.startsWith(prefix + "toggle-antibot-on")) {
        if(!message.channel.guild) return message.reply('**Only Servers | :x:**');
        if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**You Need ``MANAGE_GUILD`` | :x:**');
        if(!antb[message.guild.id]) antb[message.guild.id] = {
          onoff: 'On'
        }
          if(antb[message.guild.id].onoff === 'On') return [message.channel.send(`**AntiBots is ON Now | :white_check_mark:**`), antb[message.guild.id].onoff = 'On']
          fs.writeFile("./antibot.json", JSON.stringify(antb), (err) => {
            if (err) console.error(err)
            })
          }
        ...
        client.on('message', message => {
    if(message.content.startsWith(prefix + "toggle-antibot-off")) {
        if(!message.channel.guild) return message.reply('**Only Servers | :x:**');
        if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**You Need ``MANAGE_GUILD`` | :x:**');
        if(!antb[message.guild.id]) antb[message.guild.id] = {
          onoff: 'Off'
        }
          if(antb[message.guild.id].onoff === 'Off') return [message.channel.send(`**AntiBots is off Now | :white_check_mark:**`), antb[message.guild.id].onoff = 'Off']
          fs.writeFile("./antibot.json", JSON.stringify(antb), (err) => {
            if (err) console.error(err)
            })
          }
        ...
        client.on("guildMemberAdd", member => {
            if(!ants[member.guild.id]) ants[member.guild.id] = {
                onoff: 'Off'
                }
...
var prefix = "P.";//البرفكس //Toixc Codes
if(message.channel.type === "dm") return;
if(message.author.bot) return;
